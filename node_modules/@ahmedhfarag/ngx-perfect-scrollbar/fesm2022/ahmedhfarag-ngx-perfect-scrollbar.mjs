...
class ForceNativeScrollDirective {
    ...
    constructor(renderer, el) {
        ...
        this.el = el;
        const classNames = ['ps__child', 'ps__child--consume'];
    ...
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.1.5", type: ForceNativeScrollDirective, isStandalone: false, selector: "[forceNativeScrolling]", ngImport: i0 });
}
...
class PerfectScrollbarModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.1.5", ngImport: i0, type: PerfectScrollbarModule, declarations: [PerfectScrollbarComponent, PerfectScrollbarDirective, ForceNativeScrollDirective], imports: [CommonModule], exports: [CommonModule, PerfectScrollbarComponent, PerfectScrollbarDirective, ForceNativeScrollDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.1.5", ngImport: i0, type: PerfectScrollbarModule, imports: [CommonModule, CommonModule] });
}
